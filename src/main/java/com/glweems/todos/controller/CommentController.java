package com.glweems.todos.controller;

import com.glweems.todos.exception.ResourceNotFoundException;
import com.glweems.todos.model.Comment;
import com.glweems.todos.repo.CommentRepository;
import com.glweems.todos.repo.PostRepository;
...
public class CommentController {
  ...
  public ResponseEntity<?> deleteComment(
    ...
    return commentRepository.findByIdAndPostId(commentId, postId).map(
      comment -> {
